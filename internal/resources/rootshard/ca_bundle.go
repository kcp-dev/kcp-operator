...
func MergedCABundleSecretReconciler(ctx context.Context, rootShard *operatorv1alpha1.RootShard, kubeClient client.Client) k8creconciling.NamedSecretReconcilerFactory {
