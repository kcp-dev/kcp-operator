...
type BundleStatus struct {
	// Phase is bundle phase
	Phase BundlePhase `json:"phase,omitempty"`

	// Objects are list of objects with its state for this bundle.
...
const (
	// BundlePhaseProvisioning indicates state where bundle assets are still being collected.
	BundlePhaseProvisioning BundlePhase = "Provisioning"
	// BundlePhaseReady indicates state where bundle assets are ready to be used.
	BundlePhaseReady BundlePhase = "Ready"
	// BundlePhaseDeleting bundle being deleted.
