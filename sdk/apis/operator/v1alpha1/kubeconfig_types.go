...
func (k *Kubeconfig) GetTargetName() string {
	if k.Spec.Target.RootShardRef != nil {
		return "RootShard/" + k.Spec.Target.RootShardRef.Name
	}
	if k.Spec.Target.ShardRef != nil {
		return "Shard/" + k.Spec.Target.ShardRef.Name
	}
	if k.Spec.Target.FrontProxyRef != nil {
		return "FrontProxy/" + k.Spec.Target.FrontProxyRef.Name
	}
	return ""
}
