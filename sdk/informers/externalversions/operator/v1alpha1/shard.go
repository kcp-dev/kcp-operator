...
type ShardClusterInformer interface {
	...
	Lister() operatorv1alpha1listers.ShardClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.OperatorV1alpha1().Shards().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OperatorV1alpha1().Shards().Watch(context.TODO(), options)
			},
		},
		&operatorv1alpha1.Shard{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *shardClusterInformer) Informer() kcpcache.ScopeableSharedIndexInformer {
	return f.factory.InformerFor(&operatorv1alpha1.Shard{}, f.defaultInformer)
}

func (f *shardClusterInformer) Lister() operatorv1alpha1listers.ShardClusterLister {
	return operatorv1alpha1listers.NewShardClusterLister(f.Informer().GetIndexer())
}
...
type ShardInformer interface {
	...
	Lister() operatorv1alpha1listers.ShardLister
}
...
func (f *shardInformer) Lister() operatorv1alpha1listers.ShardLister {
	return f.lister
}
...
func (f *shardScopedInformer) Lister() operatorv1alpha1listers.ShardLister {
	return operatorv1alpha1listers.NewShardLister(f.Informer().GetIndexer())
}

// NewShardInformer constructs a new informer for Shard type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewShardInformer(client scopedclientset.Interface, resyncPeriod time.Duration, namespace string, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredShardInformer(client, resyncPeriod, namespace, indexers, nil)
}

// NewFilteredShardInformer constructs a new informer for Shard type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredShardInformer(client scopedclientset.Interface, resyncPeriod time.Duration, namespace string, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.OperatorV1alpha1().Shards(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OperatorV1alpha1().Shards(namespace).Watch(context.TODO(), options)
			},
		},
		&operatorv1alpha1.Shard{},
		resyncPeriod,
...
func (f *shardScopedInformer) defaultInformer(client scopedclientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredShardInformer(client, resyncPeriod, f.namespace, cache.Indexers{
