...
// RootShardApplyConfiguration represents a declarative configuration of the RootShard type for use
// with apply.
...
// RootShard constructs a declarative configuration of the RootShard type for use with
// apply.
func RootShard(name, namespace string) *RootShardApplyConfiguration {
	b := &RootShardApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("RootShard")
...
func (b *RootShardApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
