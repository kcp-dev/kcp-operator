...
func (b *ShardApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
...
func (b *ShardApplyConfiguration) WithStatus(value operatorv1alpha1.ShardStatus) *ShardApplyConfiguration {
	b.Status = &value
	return b
}
