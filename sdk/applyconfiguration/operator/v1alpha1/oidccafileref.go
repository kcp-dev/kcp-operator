...
// OIDCCAFileRefApplyConfiguration represents a declarative configuration of the OIDCCAFileRef type for use
// with apply.
...
// OIDCCAFileRefApplyConfiguration constructs a declarative configuration of the OIDCCAFileRef type for use with
// apply.
func OIDCCAFileRef() *OIDCCAFileRefApplyConfiguration {
	return &OIDCCAFileRefApplyConfiguration{}
}
