...
type BundleStatusApplyConfiguration struct {
	Phase      *operatorv1alpha1.BundlePhase          `json:"phase,omitempty"`
...
func (b *BundleStatusApplyConfiguration) WithPhase(value operatorv1alpha1.BundlePhase) *BundleStatusApplyConfiguration {
	b.Phase = &value
	return b
}
