...
// DeploymentSpecTemplateApplyConfiguration represents a declarative configuration of the DeploymentSpecTemplate type for use
// with apply.
type DeploymentSpecTemplateApplyConfiguration struct {
	Template *PodTemplateSpecApplyConfiguration `json:"template,omitempty"`
}

// DeploymentSpecTemplateApplyConfiguration constructs a declarative configuration of the DeploymentSpecTemplate type for use with
// apply.
func DeploymentSpecTemplate() *DeploymentSpecTemplateApplyConfiguration {
	return &DeploymentSpecTemplateApplyConfiguration{}
}
