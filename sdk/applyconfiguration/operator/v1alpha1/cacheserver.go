...
// CacheServerApplyConfiguration represents a declarative configuration of the CacheServer type for use
// with apply.
...
// CacheServer constructs a declarative configuration of the CacheServer type for use with
// apply.
func CacheServer(name, namespace string) *CacheServerApplyConfiguration {
	b := &CacheServerApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("CacheServer")
...
func (b *CacheServerApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
