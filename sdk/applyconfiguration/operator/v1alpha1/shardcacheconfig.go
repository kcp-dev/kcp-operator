...
// ShardCacheConfigApplyConfiguration represents a declarative configuration of the ShardCacheConfig type for use
// with apply.
type ShardCacheConfigApplyConfiguration struct {
	Reference *v1.LocalObjectReference `json:"ref,omitempty"`
}

// ShardCacheConfigApplyConfiguration constructs a declarative configuration of the ShardCacheConfig type for use with
// apply.
func ShardCacheConfig() *ShardCacheConfigApplyConfiguration {
	return &ShardCacheConfigApplyConfiguration{}
}
